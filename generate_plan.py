...
المطلوب:
1- لكل كلمة مفتاحية حقيقية بالأعلى، أريدك أن تقترح (3 إلى 10) عناوين مقالات تغطي الكلمة من "زوايا مختلفة" بناءً على نتائج البحث الحالية والفعليّة (Real-time data).
...
6- الأهم: حدد "نية الباحث" (Search Intent) بدقة شديدة لكل عنوان من ضمن هذه القائمة فقط (اختر نية واحدة أو نيتين كحد أقصى تناسب العنوان):[معلوماتية, ملاحية, استقصائية, شرائية, محلية, معلومة موجزة, وسائط, بحث مجاني, إجرائية, مختلطة, حداثة/تريند, حل مشكلات, ترفيهية, أريد أن أفعل, أريد أن أذهب, موسمية, مقارنة, ضمنية]
